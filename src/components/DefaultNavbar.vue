    ...
    <nav class="bg-[#E1F7F5]">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="w-full lg:block lg:w-auto hidden" id="navbar-default">
          <ul
            class="font-medium flex flex-col lg:p-0 mt-4 rounded-lg lg:flex-row lg:mt-0 lg:gap-14"
          >
            <li>
              <RouterLink
                to="/"
                class="block py-2 px-3 text-[#0E46A3] rounded lg:bg-transparent lg:py-1"
                aria-current="page"
                >Home</RouterLink
              >
            </li>
            ...
            <li class="relative">
              <button
                ...
                class="flex items-center justify-between w-full py-2 px-3 text-[#0E46A3] rounded lg:py-1"
              >
                Accomodation
                <!-- Ikon dinamis yang berubah berdasarkan status dropdown -->
                <svg
                  :class="showDropdown ? 'transform rotate-180' : ''"
            ...
            <li>
              <RouterLink to="/activities" class="block py-2 px-3 text-[#0E46A3] rounded lg:py-1">
                Activities
              </RouterLink>
            </li>
            <li>
