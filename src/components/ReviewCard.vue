...
<template>
  <section class="p-16 mt-10 relative">
    ...
    <div class="container">
      <swiper-container pagination-el=".swiper-pagination" navigation-next-el=".swiper-button-next"
        navigation-prev-el=".swiper-button-prev" class="review-slider max-w-screen-lg" effect="coverflow"
          ...
          <div class="swiper-wrapper">
            <div
              ...
              <div class="flex items-center gap-5">
                <img class="rounded-full object-cover" src="https://pagedone.io/asset/uploads/1696229969.png"
                  alt="avatar" />
