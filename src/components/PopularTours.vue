...
<template>
  <section class="my-20 max-w-screen-xl flex flex-col items-center mx-auto">
    ...
    <div class="container">
      <swiper-container
        ...
        class="popular-slider max-w-screen-lg"
        effect="coverflow"
        :grab-cursor="true"
      ...
      >
        <swiper-slide
          class="popular-slide"
          v-for="destination in destinations.data.slice(0, maxShowedData)"
          :key="destination.id"
        >
